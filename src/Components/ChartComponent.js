...
import { ChartContainer, ChartRow, Charts, YAxis, ScatterChart, LineChart, Resizable, Legend, styler } from 'react-timeseries-charts';
...
class ChartComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(process.env.REACT_APP_BACKEND_URL + 'getSensorData')
            .then(res => {
                console.log(res);
            })
